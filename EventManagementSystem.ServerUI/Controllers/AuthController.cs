...
namespace EventManagementSystem.ServerUI.Controllers
{
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> SignUp(SignUpVM signUpVM)
        {
            ...
            var result = await _authService.RegisterAsync(signUpVM);
            ...
            return Json(new { success = true, message = successMessage, redirectUrl = Url.Action("EmailVerification", "Auth") });
        }
        ...
        public async Task<IActionResult> SignIn(SignInVM signInVM)
        {
            ...
            var result = await _authService.LoginAsync(signInVM);
